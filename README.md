...
`28.11.2022` - e-objects 1.20.2 перенесен в functions.py. Удалена загрузка репозитория при перезапуске.

`17.03.2021` - _Крупное обновление. Версия 6_

`07.03.2021` - Начал писать шестую версию данного бота. Подготовка к крупному обновлению.

`04.03.2021` - Что-то затянул я с апдейтом, текущая версия по непонятным причинам стала выходить из строя. Пробую
выяснить что с этим можно сделать.
